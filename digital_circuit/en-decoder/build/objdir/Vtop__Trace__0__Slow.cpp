...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+2,"ena", false,-1);
    tracep->declBus(c+3,"y", false,-1, 2,0);
    tracep->declBit(c+4,"idx", false,-1);
    ...
    tracep->pushNamePrefix("u_encode3 ");
    tracep->declBus(c+1,"x", false,-1, 7,0);
    tracep->declBit(c+2,"ena", false,-1);
    tracep->declBus(c+3,"y", false,-1, 2,0);
    tracep->declBit(c+4,"idx", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelf->ena));
    bufp->fullCData(oldp+3,(vlSelf->y),3);
    bufp->fullBit(oldp+4,(vlSelf->idx));
    bufp->fullCData(oldp+5,(vlSelf->h),7);
